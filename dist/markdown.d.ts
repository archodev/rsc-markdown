interface HTMLReactParserOptions {
    replace?: (domNode: Element | any, index?: number) => React.ReactElement | undefined;
    transform?: (reactNode: React.ReactElement, domNode: Element | any, index: number) => React.ReactElement;
    library?: {
        cloneElement: (element: React.ReactElement, props: any, ...children: React.ReactNode[]) => React.ReactElement;
        createElement: (type: any, props?: any, ...children: React.ReactNode[]) => React.ReactElement;
